...
const { DraftrollProvider, useDraftrollRolls, useDraftrollSession } = createDraftrollReactBindings(React);
...
export function App() {
  return <DraftrollProvider session={session} disposeOnUnmount><Roller /></DraftrollProvider>;
}
