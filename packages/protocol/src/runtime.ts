/**
 * Safe public runtime-validation boundaries.
 *
 * @remarks
 * The validator implementation lives in `runtime-internal.ts`. Public decoders that accept
 * arbitrary objects first detach structured-cloneable data so hostile proxies, throwing getters,
 * and caller-owned mutable objects cannot leak through the package boundary.
 *
...
/**
 * Decodes roll visibility from a detached boundary value.
 *
 * @public
 */
...
/**
 * Decodes room policy from a detached boundary value.
 *
 * @public
 */
...
/**
 * Decodes a room-policy patch from a detached boundary value.
 *
 * @public
 */
...
/**
 * Decodes participant identity from a detached boundary value.
 *
 * @public
 */
...
/**
 * Decodes room capability-token claims from a detached boundary value.
 *
 * @public
 */
...
/**
 * Decodes roll input from a detached boundary value.
 *
 * @public
 */
...
/**
 * Decodes roll-update input from a detached boundary value.
 *
 * @public
 */
...
/**
 * Decodes a client-to-server event from a detached boundary value.
 *
 * @public
 */
...
/**
 * Parses a client-to-server event without throwing for hostile input.
 *
 * @public
 */
...
/**
 * Determines whether a value is valid roll visibility without throwing for hostile input.
 *
 * @public
 */
